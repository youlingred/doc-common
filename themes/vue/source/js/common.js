    ...
    if (apiContent) {
      ...
      apiTitles.forEach(function(titleNode) {
        ...
        if (ulNode.tagName === "UL") {
          ...
          specNode.innerHTML =
            '<a href="' + specLink + '" target="_blank">源代码</a>';
  ...
  function initVideoModal() {
    ...
    modalButton.addEventListener("click", function(event) {
      ...
      videoWrapper.innerHTML =
        '<iframe style="height: 100%; left: 0; position: absolute; top: 0; width: 100%;" src="//player.youku.com/embed/XMzMwMTYyODMyNA==" frameborder="0" allowfullscreen></iframe>';
    });
